...
### 🛠️ [Workforce Automation Portal (WAP)](https://github.com/saksham634)
_An automated enterprise management portal engineered for attendance tracking, leave management, and payroll processing._
...
* Integrated an AI-driven chatbot using Groq AI API for instant query resolutions.

### 💬 [OnlineChat App](https://github.com/saksham634)
_A real-time messaging application designed with responsive communication workflows and user status tracking._
...
_An interactive data-driven dashboard evaluating key metrics for workforce planning, employee performance, and retention._
...
*Explore more repositories on [my GitHub profile](https://github.com/saksham634?tab=repositories)*
